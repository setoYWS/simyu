...
?>
<!-- Form Edit Product -->
<!--Baca komen dibawah ya, biar gk salah paham-->
<!--ner, yang id ny di atribut action aq ganti-->
<form action="update-penjualan.php?id=<?php echo $id_penjualan;?>" method="post">
